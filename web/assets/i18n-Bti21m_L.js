...
import { t as createI18n } from "./vendor-i18n-B4rt6w-9.js";
...
var Comfy_Canvas_FitView = { "label": "Focus selection or fit entire graph" };
var Comfy_Canvas_FocusExecutionErrorNodes = { "label": "Focus nodes with execution errors" };
var Comfy_Canvas_SelectNodesWithSameModelWidget = { "label": "Select nodes sharing the same model combo" };
var Comfy_Canvas_GfvWireMarqueeSelect = { "label": "Marquee-select wires" };
var Comfy_Canvas_GfvWireSelectToggle = { "label": "Select or toggle wire" };
var Comfy_Canvas_WireScissors = { "label": "Cut wires (hold)" };
var Comfy_Canvas_LayoutGraph = { "label": "Auto-layout graph" };
...
var Comfy_Canvas_NodeColorPalette = { "label": "Node color palette" };
var Comfy_Canvas_ResetAllNodeColors = { "label": "Reset all node colors" };
var Comfy_Canvas_NodeShapePalette = { "label": "Node sticker palette" };
...
var commands_default = {
	...
	Comfy_Canvas_FocusExecutionErrorNodes,
	Comfy_Canvas_SelectNodesWithSameModelWidget,
	Comfy_Canvas_GfvWireMarqueeSelect,
	Comfy_Canvas_GfvWireSelectToggle,
	Comfy_Canvas_WireScissors,
	Comfy_Canvas_LayoutGraph,
	Comfy_Canvas_Lock,
	Comfy_Canvas_MoveSelectedNodes_Down,
	Comfy_Canvas_MoveSelectedNodes_Left,
	Comfy_Canvas_MoveSelectedNodes_Right,
	Comfy_Canvas_MoveSelectedNodes_Up,
	Comfy_Canvas_NodeColorPalette,
	Comfy_Canvas_ResetAllNodeColors,
	Comfy_Canvas_NodeShapePalette,
...
var main_default = {
	...
	toastMessages: {
		...
		"noExecutionErrorsOnGraph": "No execution errors on nodes",
		"executionErrorNodesNotInCurrentGraph": "Error nodes are not in the current graph",
		"noModelComboOnSelectedNode": "No model combo widget found on the selected node",
		"noOtherNodesShareModelCombo": "No other nodes share that model value",
		"nodeColorsReset": "All node colors reset to defaults (this graph and saved type defaults cleared).",
	...
	nodeColorPalette: {
		"title": "Node colors",
		"hint": "Click a swatch for the current selection, or drag a swatch onto a node. Drop on a selected node to recolor the whole selection. Ctrl+click or Ctrl+drag tints every node of that type and saves the default for new nodes. Press C to toggle this panel.",
		"nodeTypeLabel": "Type:",
		"hasSavedDefault": "(saved default for this type)",
		"noSelection": "No selection — click nodes to choose a type for Ctrl+bulk actions.",
		"accentPicker": "Accent color",
		"presets": "Classic",
		"grid": "Spectrum",
		"applySelection": "Apply to selected nodes",
		"applyAllType": "Apply to all nodes of this type + remember for new nodes",
		"clearSaved": "Clear saved default for this type",
		"toastNoSelection": "Select one or more nodes to recolor.",
		"toastNoTypeForBulk": "Select a node first so its type is known for Ctrl+bulk coloring."
	},
	nodeStickerPalette: {
		"title": "Node stickers",
		"hint": "Pick an icon for the selected nodes — it floats above the top-left corner. Saved with the workflow. Press Z to toggle.",
		"sizeLabel": "Sticker size",
		"noSelection": "Select at least one node.",
		"clear": "None",
		"stickers": {
			"lightbulb": "Bulb",
			"skull": "Skull",
	...
	minimap: {
		...
		"semanticLayers": "Semantic layers (roles)"
	},
	nightlySurvey: {
	...
	rightSidePanel: {
		...
		"globalSettings": {
			...
			"nodes2": "Modern Node Design (Nodes 2.0)",
...
var Comfy_VueNodes_AutoScaleLayout = {
	"name": "Auto-scale layout (DOM nodes)",
	"tooltip": "Automatically scale node positions when switching to Modern Node Design (DOM rendering) to prevent overlap"
};
var Comfy_VueNodes_Enabled = {
	"name": "Modern Node Design (Nodes 2.0)",
	"tooltip": "DOM-based “Modern” look (Comfy’s Nodes 2.0). Classic: traditional canvas rendering."
};
...
var localeLoaders = {
	ar: () => __vitePreload(() => import("./main-CCAoHzS_.js"), [], import.meta.url),
	es: () => __vitePreload(() => import("./main-BtvSNhk5.js"), [], import.meta.url),
	fa: () => __vitePreload(() => import("./main-C4PzBfL2.js"), [], import.meta.url),
	fr: () => __vitePreload(() => import("./main-BRkC1B8m.js"), [], import.meta.url),
	ja: () => __vitePreload(() => import("./main-xbI84gLQ.js"), [], import.meta.url),
	ko: () => __vitePreload(() => import("./main-DFtcldwN.js"), [], import.meta.url),
	ru: () => __vitePreload(() => import("./main-BRkPQm3A.js"), [], import.meta.url),
	tr: () => __vitePreload(() => import("./main-DWVZtR5y.js"), [], import.meta.url),
	zh: () => __vitePreload(() => import("./main-ZmVHc-xO.js"), [], import.meta.url),
	"zh-TW": () => __vitePreload(() => import("./main-bnoBNNbW.js"), [], import.meta.url),
	"pt-BR": () => __vitePreload(() => import("./main-BJbDMfpL.js"), [], import.meta.url)
};
var nodeDefsLoaders = {
	ar: () => __vitePreload(() => import("./nodeDefs-Dri88Fyf.js"), [], import.meta.url),
	es: () => __vitePreload(() => import("./nodeDefs-Cc0ZU18z.js"), [], import.meta.url),
	fa: () => __vitePreload(() => import("./nodeDefs-BIb70T_n.js"), [], import.meta.url),
	fr: () => __vitePreload(() => import("./nodeDefs-Azf0Mc64.js"), [], import.meta.url),
	ja: () => __vitePreload(() => import("./nodeDefs-D-9V5f58.js"), [], import.meta.url),
	ko: () => __vitePreload(() => import("./nodeDefs-B3iQFTeW.js"), [], import.meta.url),
	ru: () => __vitePreload(() => import("./nodeDefs-CHLYXhay.js"), [], import.meta.url),
	tr: () => __vitePreload(() => import("./nodeDefs-Ci8N7Jw1.js"), [], import.meta.url),
	zh: () => __vitePreload(() => import("./nodeDefs-B2hVyQ7p.js"), [], import.meta.url),
	"zh-TW": () => __vitePreload(() => import("./nodeDefs-DUnFTfDb.js"), [], import.meta.url),
	"pt-BR": () => __vitePreload(() => import("./nodeDefs-DZq15-jq.js"), [], import.meta.url)
};
var commandsLoaders = {
	ar: () => __vitePreload(() => import("./commands-CsUnvyWM.js"), [], import.meta.url),
	es: () => __vitePreload(() => import("./commands-gUrOGERO.js"), [], import.meta.url),
	fa: () => __vitePreload(() => import("./commands-CECR3xgW.js"), [], import.meta.url),
	fr: () => __vitePreload(() => import("./commands-zAlbL_Xn.js"), [], import.meta.url),
	ja: () => __vitePreload(() => import("./commands-BOUDJJ6g.js"), [], import.meta.url),
	ko: () => __vitePreload(() => import("./commands-B_H2IDNA.js"), [], import.meta.url),
	ru: () => __vitePreload(() => import("./commands-CZuuIt4m.js"), [], import.meta.url),
	tr: () => __vitePreload(() => import("./commands-BGl4jXyX.js"), [], import.meta.url),
	zh: () => __vitePreload(() => import("./commands-CG559kJc.js"), [], import.meta.url),
	"zh-TW": () => __vitePreload(() => import("./commands-Hi8RmbiW.js"), [], import.meta.url),
	"pt-BR": () => __vitePreload(() => import("./commands-CtbPhBfM.js"), [], import.meta.url)
};
var settingsLoaders = {
	ar: () => __vitePreload(() => import("./settings-BafyIWGA.js"), [], import.meta.url),
	es: () => __vitePreload(() => import("./settings-Dev4mpPn.js"), [], import.meta.url),
	fa: () => __vitePreload(() => import("./settings-DdACtCSy.js"), [], import.meta.url),
	fr: () => __vitePreload(() => import("./settings-lpzcom_5.js"), [], import.meta.url),
	ja: () => __vitePreload(() => import("./settings-DABetgTO.js"), [], import.meta.url),
	ko: () => __vitePreload(() => import("./settings-CQxMGzG_.js"), [], import.meta.url),
	ru: () => __vitePreload(() => import("./settings-DEZ3RZmz.js"), [], import.meta.url),
	tr: () => __vitePreload(() => import("./settings-BzGksVti.js"), [], import.meta.url),
	zh: () => __vitePreload(() => import("./settings-B1YZs8zE.js"), [], import.meta.url),
	"zh-TW": () => __vitePreload(() => import("./settings-CwMw4_kx.js"), [], import.meta.url),
	"pt-BR": () => __vitePreload(() => import("./settings-DuvMyarK.js"), [], import.meta.url)
};
...
//# sourceMappingURL=i18n-Bti21m_L.js.map